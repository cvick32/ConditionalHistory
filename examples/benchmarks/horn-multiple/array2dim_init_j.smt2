...
(declare-rel inv1 ( (Array Int (Array Int Int)) Int Int Int))(declare-rel inv2 ( (Array Int (Array Int Int)) Int Int Int Int))(declare-rel fail ( ))(forall ((a (Array Int (Array Int Int))) (M Int) (N Int))
  (! (inv1 a 0 M N) ))(forall ((i1 Int) (a (Array Int (Array Int Int))) (i Int) (M Int) (N Int))
  (! (=> (and (inv1 a i M N) (< i M) (= i1 (+ i 1))) (inv2 a i 0 M N))
     ))(forall ((a (Array Int (Array Int Int)))
         (j Int)
         ...
         (M Int)
         (N Int))
  (! (let ((a!1 (= a1 (store a i (store (select a i) j j)))))
  ...
  (! (=> (and (inv2 a i j M N) (not (< j N)) (= i1 (+ i 1))) (inv1 a i1 M N))
         ...
         (i1 Int)
         (j1 Int))
  (! (let ((a!1 (not (= (select (select a i1) j1) j1))))
       (=> (and (inv1 a i M N)
                (not (< i M))
                (<= 0 i1)
                (< i1 M)
