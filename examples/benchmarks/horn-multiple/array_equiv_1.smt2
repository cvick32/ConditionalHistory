(set-logic HORN)
(declare-rel inv0 ( (Array Int Int) Int Int Int))(declare-rel inv1 ( (Array Int Int) (Array Int Int) Int Int Int))(declare-rel fail ( ))(forall ((a (Array Int Int)) (c Int) (n Int)) (! (inv0 a 0 c n) ))(forall ((a (Array Int Int))
         (i Int)
         (a1 (Array Int Int))
         (i1 Int)
         (c Int)
