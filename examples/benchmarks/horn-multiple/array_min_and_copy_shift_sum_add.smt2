(set-logic HORN)
(declare-rel inv1 ( (Array Int Int) Int Int Int))(declare-rel inv2 ( (Array Int Int) (Array Int Int) Int Int Int))(declare-rel inv3 ( (Array Int Int) (Array Int Int) Int Int Int Int))(declare-rel fail ( ))(forall ((a (Array Int Int)) (j Int) (N Int)) (! (inv1 a 0 j N) ))(forall ((j Int) (i Int) (a (Array Int Int)) (i1 Int) (j1 Int) (N Int))
